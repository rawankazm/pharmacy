...
const DEFAULT_PRODUCTS = [
    { id: 1001, name: 'Paracetamol 500mg', name_ckb: 'پاراسیتامۆڵ ٥٠٠ ملگم', category: 'Dairy & Cheese', price: 1000, barcode: '8690624101234', image_url: 'https://images.unsplash.com/photo-1584017911766-d451b3d0e843?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, description: 'box', created_at: new Date().toISOString() },
    { id: 1002, name: 'Panadol Extra', name_ckb: 'پانادۆڵ ئیكسترا', category: 'Dairy & Cheese', price: 2000, barcode: '5000159461122', image_url: 'https://images.unsplash.com/photo-1607619056574-7b8f30413736?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
    { id: 1003, name: 'Amoxicillin 500mg', name_ckb: 'ئەمۆکسیسیلین ٥٠٠ ملگم', category: 'Dairy & Cheese', price: 3500, barcode: '7622300336738', image_url: 'https://images.unsplash.com/photo-1631549916768-4119b2e5f926?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
    { id: 1004, name: 'Cough Syrup 100ml', name_ckb: 'شرووبی کۆکە ١٠٠ مل', category: 'Beverages', price: 4000, barcode: '012000000133', image_url: 'https://images.unsplash.com/photo-1584017911766-d451b3d0e843?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
    { id: 1005, name: 'Vitamin C Effervescent', name_ckb: 'ڤیتامین سی حەپی تواوە', category: 'Snacks & Sweets', price: 3000, barcode: '5449000000996', image_url: 'https://images.unsplash.com/photo-1616679911721-eff6eec18fcd?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
    { id: 1006, name: 'Diclofenac Injection', name_ckb: 'دەرزی دیکلۆفیناک', category: 'Pantry & Grains', price: 1500, barcode: '5900543015483', image_url: 'https://images.unsplash.com/photo-1628771065518-0d82f1938462?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
    { id: 1007, name: 'Insulin Syringe', name_ckb: 'سرنجی ئەنسۆلین', category: 'Pantry & Grains', price: 500, barcode: '8692943016572', image_url: 'https://images.unsplash.com/photo-1579684389782-64d84b5e901a?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
    { id: 1008, name: 'Medical Mask 50pcs', name_ckb: 'دەمامکی پزیشکی ٥٠ دانە', category: 'Bakery', price: 5000, barcode: '6281007000109', image_url: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
    { id: 1009, name: 'Bandages Assorted', name_ckb: 'لەزگەی برینپێچ جۆراوجۆر', category: 'Bakery', price: 1500, barcode: '5707311029272', image_url: 'https://images.unsplash.com/photo-1590611380053-eef40d42fa89?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
    { id: 1010, name: 'Voltaren Emulgel', name_ckb: 'مەرهەمی ڤۆڵتارین', category: 'Household & Cleaning', price: 6500, barcode: '8906010061234', image_url: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
    { id: 1011, name: 'Burn Ointment', name_ckb: 'مەرهەمی سووتاوی', category: 'Household & Cleaning', price: 4000, barcode: '8690500123456', image_url: 'https://images.unsplash.com/photo-1628771065518-0d82f1938462?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
];
...
const initDefaultProducts = () => {
    try {
        ...
        const updated = existing.map(p => {
            ...
            if (defaultProd) {
                // If it has a broken/null image, or uses the old broken unsplash photo id, update it to the new working one
                if (!p.image_url || p.image_url.includes('photo-1584308666744-24d5e478eb04') || p.image_url.includes('photo-1550572017-edb98eb6c342')) {
