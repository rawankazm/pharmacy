...
const DEFAULT_PRODUCTS = [
    { id: 1001, name: 'Paracetamol 500mg', name_ckb: 'پاراسیتامۆڵ ٥٠٠ ملگم', category: 'Dairy & Cheese', price: 1000, barcode: '8690624101234', image_url: 'https://images.unsplash.com/photo-1584308666744-24d5e478eb04?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, description: 'box', created_at: new Date().toISOString() },
    { id: 1002, name: 'Panadol Extra', name_ckb: 'پانادۆڵ ئیكسترا', category: 'Dairy & Cheese', price: 2000, barcode: '5000159461122', image_url: 'https://images.unsplash.com/photo-1584308666744-24d5e478eb04?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
    ...
    { id: 1005, name: 'Vitamin C Effervescent', name_ckb: 'ڤیتامین سی حەپی تواوە', category: 'Snacks & Sweets', price: 3000, barcode: '5449000000996', image_url: 'https://images.unsplash.com/photo-1550572017-edb98eb6c342?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
    ...
    { id: 1007, name: 'Insulin Syringe', name_ckb: 'سرنجی ئەنسۆلین', category: 'Pantry & Grains', price: 500, barcode: '8692943016572', image_url: 'https://images.unsplash.com/photo-1631549916768-4119b2e5f926?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
    { id: 1008, name: 'Medical Mask 50pcs', name_ckb: 'دەمامکی پزیشکی ٥٠ دانە', category: 'Bakery', price: 5000, barcode: '6281007000109', image_url: 'https://images.unsplash.com/photo-1586942425654-2092328510c6?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
    { id: 1009, name: 'Bandages Assorted', name_ckb: 'لەزگەی برینپێچ جۆراوجۆر', category: 'Bakery', price: 1500, barcode: '5707311029272', image_url: 'https://images.unsplash.com/photo-1584308666744-24d5e478eb04?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
    { id: 1010, name: 'Voltaren Emulgel', name_ckb: 'مەرهەمی ڤۆڵتارین', category: 'Household & Cleaning', price: 6500, barcode: '8906010061234', image_url: 'https://images.unsplash.com/photo-1610488661608-8df004126786?auto=format&fit=crop&q=80&w=200', is_available: true, track_stock: true, stock_quantity: 100, created_at: new Date().toISOString() },
